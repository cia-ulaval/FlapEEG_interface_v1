...
def convert_cv2_frame_to_pygame_surface(cv2_frame):
    """
...
def main():
    ...
    pygame.display.set_caption("EEG Blink Task - Single Window (Fullscreen)")

    fullscreen = True  # We'll toggle this with the 'F' key if desired
    ...
    while running:
        ...
        if cap.isOpened():
            ...
            if ret:
                ...
                cam_surface = convert_cv2_frame_to_pygame_surface(frame)
