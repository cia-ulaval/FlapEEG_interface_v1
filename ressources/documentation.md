...
- [Documentation for our EEG](https://docs.openbci.com/)
- [Extraction des caractéristiques](https://www.kaggle.com/code/sohamkumarchauhan/eeg-preprocessing-and-feature-extraction)
...
### Dataset
- [Publicly Available EEG Dataset](https://openbci.com/community/publicly-available-eeg-datasets/)
- [Research Resource for Complex Physiologic Signals](https://physionet.org/)
- [EEG Data](https://openneuro.org/)
- [EEG Data](https://moabb.neurotechx.com/docs/index.html)
